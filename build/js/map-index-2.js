...
$(document).ready(function () {
    ...
    function AutocompleteDirectionsHandler(map) {
        ...
        var originInput = document.getElementById('fromAdress');
        var destinationInput = document.getElementById('toAdress');
        ...
        autocomplete.addListener('place_changed', function () { // İSTİQAMƏTİN DƏYİŞMƏSİ FUNKSİYASI
            ...
            if (mode === 'ORIG') {
                ...
                service.getDetails({
                    ...
                    var hidenInputFromLat = document.getElementById("fromAdressLat");
                    hidenInputFromLat.value = inputResultLat;
                    var hidenInputFromLng = document.getElementById("fromAdressLng");
                    hidenInputFromLng.value = inputResultLng;
                ...
                service.getDetails({
                    ...
                    var hidenInputToLat = document.getElementById("toAdressLat");
                    hidenInputToLat.value = inputResultLat;

                    var hidenInputToLng = document.getElementById("toAdressLng");
                    hidenInputToLng.value = inputResultLng;
